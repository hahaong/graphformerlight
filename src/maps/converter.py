...
def sumo2cityflow_flow(args):
    ...
    sumocfg = os.path.join(f_cwd, args.sumocfg)
...
def cityflow2sumo_flow(args):
    ...
    sumofile = os.path.join(os.getcwd(), args.or_sumotraffic)
    cityflowfile = os.path.join(os.getcwd(), args.cityflowtraffic)
...
def cityflow2sumo_net(args):
    ...
    sumofile = os.path.join(os.getcwd(), args.or_sumonet)
    cityflowfile = os.path.join(os.getcwd(), args.cityflownet)
