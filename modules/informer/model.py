...
from modules.informer.encoder import Encoder, EncoderLayer, ConvLayer, EncoderStack
from modules.informer.decoder import Decoder, DecoderLayer
from modules.informer.attn import FullAttention, ProbAttention, AttentionLayer
from modules.informer.embed import DataEmbedding
...
class Informer(nn.Module):
    def __init__(self, enc_in, dec_in, c_out, seq_len, label_len, out_len,
                 ...
                 device=torch.device('cuda:0')): # 2 e_layers
        ...
        self.encoder = Encoder(
            ...
            norm_layer=torch.nn.LayerNorm(d_model) # 256
        )
        # Decoder
